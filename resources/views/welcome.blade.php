                            ...
                            <div class="tab-pane fade show active" id="tab1">
                                <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-1.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-18.jpg') }}" alt="product">
                                            </a>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-2.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-17.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>sale</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-3.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-16.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>new</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-4.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-15.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>sale</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-5.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-14.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>new</span>
                            ...
                            <div class="tab-pane fade" id="tab2">
                                <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-6.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-13.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>new</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-7.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-12.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>sale</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-8.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-11.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>new</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-9.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-10.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>sale</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-10.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-9.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>new</span>
                            ...
                            <div class="tab-pane fade" id="tab3">
                                <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-11.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-8.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>new</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-12.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-7.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>sale</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-13.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-6.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>new</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-14.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-5.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>sale</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-15.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-4.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>new</span>
                            ...
                            <div class="tab-pane fade" id="tab4">
                                <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-16.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-3.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>new</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-17.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-2.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>sale</span>
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            <a href="product-details.html">
                                                <img class="pri-img" src="{{ asset('front/assets/img/product/product-18.jpg') }}" alt="product">
                                                <img class="sec-img" src="{{ asset('front/assets/img/product/product-1.jpg') }}" alt="product">
                                            </a>
                                            <div class="product-badge">
                                                <div class="product-label new">
                                                    <span>new</span>
                    ...
                    <div class="product-banner-carousel slick-row-10">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="{{ asset('front/assets/img/banner/img1-middle.jpg') }}" alt="product banner">
                                </a>
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="{{ asset('front/assets/img/banner/img2-middle.jpg') }}" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="{{ asset('front/assets/img/banner/img3-middle.jpg') }}" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="{{ asset('front/assets/img/banner/img4-middle.jpg') }}" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="{{ asset('front/assets/img/banner/img5-middle.jpg') }}" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                            ...
                            <div class="group-list-carousel">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-1.jpg') }}" alt="">
                                            </a>
                                        </div>
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-3.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-5.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-7.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-9.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-11.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-13.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-15.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                            ...
                            <div class="group-list-carousel">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-17.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-16.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-12.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-7.jp') }}g" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-2.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-18.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-slide-item">
                                    <div class="group-item">
                                        <div class="group-item-thumb">
                                            <a href="product-details.html">
                                                <img src="{{ asset('front/assets/img/product/product-14.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="group-item-desc">
                                            <h5 class="group-product-name"><a href="product-details.html">
                ...
                <div class="col-12">
                    <div class="blog-carousel-active slick-row-10 slick-arrow-style">
                        ...
                        <div class="blog-post-item">
                            <figure class="blog-thumb">
                                <a href="blog-details.html">
                                    <img src="{{ asset('front/assets/img/blog/blog-img1.jpg') }}" alt="blog image">
                                </a>
                            </figure>
                        ...
                        <div class="blog-post-item">
                            <figure class="blog-thumb">
                                <a href="blog-details.html">
                                    <img src="{{ asset('front/assets/img/blog/blog-img2.jpg') }}" alt="blog image">
                                </a>
                            </figure>
                            <div class="blog-content">
                                <div class="blog-meta">
                        ...
                        <div class="blog-post-item">
                            <figure class="blog-thumb">
                                <a href="blog-details.html">
                                    <img src="{{ asset('front/assets/img/blog/blog-img3.jpg') }}" alt="blog image">
                                </a>
                            </figure>
                            <div class="blog-content">
                                <div class="blog-meta">
                        ...
                        <div class="blog-post-item">
                            <figure class="blog-thumb">
                                <a href="blog-details.html">
                                    <img src="{{ asset('front/assets/img/blog/blog-img4.jpg') }}" alt="blog image">
                                </a>
                            </figure>
                            <div class="blog-content">
                                <div class="blog-meta">
                        ...
                        <div class="blog-post-item">
                            <figure class="blog-thumb">
                                <a href="blog-details.html">
                                    <img src="{{ asset('front/assets/img/blog/blog-img5.jpg') }}" alt="blog image">
                                </a>
                            </figure>
                            <div class="blog-content">
                                <div class="blog-meta">
