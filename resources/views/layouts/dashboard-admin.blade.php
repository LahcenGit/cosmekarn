...
<html lang="en">
    ...
    <head>
        ...
        <title>Cosmekarn- Admin dashboard</title>
        <!-- Favicon icon -->
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                ...
                <img class="brand-title" src="{{ asset('dashboard/images/logo-text-white.pn') }}g" alt="">
            </a>
            ...
            <div class="deznav-scroll">
				...
				<li class="nav-label first">Main Menu</li>
                   ...
                   <li class="nav-label"|>Catégories</li>
                    ...
                    <li class="nav-label">Variants</li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{url('admin/attributes')}}">Tous</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{url('admin/products')}}">Tous</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{url('admin/orders/create')}}">Ajouter</a></li>
                            <li><a href="{{url('admin/orders')}}">Ajouter</a></li>
                        </ul>
                    </li>
